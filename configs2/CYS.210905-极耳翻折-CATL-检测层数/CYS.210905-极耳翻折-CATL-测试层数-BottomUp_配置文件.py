...
_base_ = [
    ...
    '../CYS.210905-极耳翻折-CATL-检测层数/CYS.210905-极耳翻折-CATL-测试层数骨骼点配置-统一类-统一编号.py'
]
save_model_path = '/data/14-调试数据/txj/CYS.210905-极耳翻折-CATL/'
project_name = 'BatteryPoleEar'
timestamp = time.strftime('%Y%m%d_%H%M%S', time.localtime())
checkpoint_config = dict(interval=5)
evaluation = dict(interval=5000, metric='mAP', save_best='AP')
...
data_root = '/data/14-调试数据/txj/BatteryPoleEar/data_labelme/result/coco'
data = dict(
    workers_per_gpu=0,
